...
export default function OnePagerSite() {
  ...
  const [currentPage, setCurrentPage] = useState("home"); // 'home' o 'catalogue'
  ...
  // Aplicar tema a <html> para compatibilidad con Tailwind dark variant
  useEffect(() => {
    if (typeof window !== "undefined") {
  ...
  const productCategories = [
    {
      ...
      models: [
        ...
        },
        {
          title: "Llanta 2",
          description:
            "Diseño de escritorio limpio y funcional con gestión integrada de cables y acabado en roble duradero. Perfecto para oficinas en casa modernas.",
          modelUrl: "/models/llanta2.glb",
          pdfUrl: "#",
          bullets: [
            "Construcción en roble macizo",
      ...
      models: [
        {
          ...
          bullets: [
            ...
            "Soporta 100+ dispositivos inteligentes",
      ...
      models: [
        {
          ...
          description:
            "Villa contemporánea con planos de planta abiertos, grandes ventanales y materiales de construcción sostenibles. Perfecta para ubicaciones en ladera.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
          pdfUrl: "#",
          bullets: [
            "Planta de concepto abierto",
        ...
        },
        {
          ...
          bullets: [
            ...
            "Vistas panorámicas en ascensor",
          ],
        },
        {
      ...
      models: [
        {
          ...
          description:
            "Exquisito anillo de compromiso con un diamante central de 2 quilates con montura pave. Elaborado en oro blanco de 18k.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
          pdfUrl: "#",
          bullets: [
            "Diamante central de 2 quilates",
            "Montura en oro blanco de 18k",
            "Acentos de diamantes micro-pave",
          ],
        },
        {
          title: "Reloj Deportivo de Lujo",
          description:
            "Reloj mecánico automático con función cronógrafo. Cuenta con cristal de zafiro y resistencia al agua de 200m.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/NeilArmstrong.glb",
          pdfUrl: "#",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Elegante collar de perlas con perlas Akoya y broche de diamantes. Perfecto para ocasiones formales y eventos especiales.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/RobotExpressive.glb",
          pdfUrl: "#",
          bullets: [
            "Perlas Akoya grado AAA",
            "Broche incrustado de diamantes",
      ...
      models: [
        {
          ...
          description:
            "Auto deportivo eléctrico de alto rendimiento con autonomía de 500 millas y 0-60 mph en 2.5 segundos. Diseño futurista con aerodinámica avanzada.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
          pdfUrl: "#",
          bullets: [
            "Autonomía eléctrica de 500 millas",
            "0-60 mph en 2.5 segundos",
        ...
        },
        {
          ...
          description:
            "Scooter eléctrico compacto diseñado para desplazamientos urbanos. Diseño plegable ligero con autonomía de 40 millas.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/RobotExpressive.glb",
          pdfUrl: "#",
          bullets: [
            "Autonomía máxima de 40 millas",
            "Plegable para fácil almacenamiento",
            "Características de conectividad con app",
          ],
        },
      ],
    },
      ...
      models: [
        {
          ...
          description:
            "Máquina CNC de alta precisión para fabricación industrial. Cuenta con cambio automático de herramientas y monitoreo en tiempo real.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
          pdfUrl: "#",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Impresora 3D industrial a gran escala capaz de imprimir con múltiples materiales incluyendo metales y composites.",
          modelUrl: "https://modelviewer.dev/shared-assets/models/RobotExpressive.glb",
          pdfUrl: "#",
          bullets: [
  ...
  const services = [
    ...
    {
      title: "Consultoría",
      description: "Consulta experta en flujos de trabajo 3D y optimización de pipeline.",
      icon: "💡",
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xblpnkle", {
        method: "POST",
        headers: {
    ...
    <div className={isDark ? "min-h-screen bg-gray-900" : "min-h-screen bg-gray-100"}>
      ...
      <footer className={isDark ? "bg-gray-900 text-white py-8 border-t border-gray-800" : "bg-gray-100 text-gray-700 py-8 border-t border-gray-200"}>
        <div className="container mx-auto px-4 text-center">
          <p className={isDark ? "text-gray-400" : "text-gray-500"}>© 2025 Binec Studio 3D. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
